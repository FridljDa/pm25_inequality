...
```{r}
ggsave(filename = paste0("../data/18_figures/di_gee-real/map_diff_25.png"), bg = 'white', width = 15, height = 5, dpi = 300)
ggsave(filename = paste0("../data/18_figures/di_gee-real/map_diff_25.pdf"), bg = 'white', width = 15, height = 5, dpi = 300)
```
