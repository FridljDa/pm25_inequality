...
pop <- pop %>% filter(rural_urban_class == "666" & Education == "666" & Gender.Code == "A" & Race == "All")
```
...
all_burden <- all_burden %>% filter(Education == 666 & Ethnicity == "All, All Origins" & rural_urban_class == "All" & min_age == 25)
