...
ggsave(
  filename = here(paste0("data/18_figures/di_gee-real-",min_ageI,"/figure_cov_ethnicity.pdf")),
  plot = combined_plot_ethnicity,
  dpi = 300, height = 10, width = 9
)
```
...
ggsave(
  filename = here(paste0("data/18_figures/di_gee-real-",min_ageI,"/figure_cov_education.pdf")),
  plot = combined_plot,
  dpi = 300, height = 12, width = 9
)
```
