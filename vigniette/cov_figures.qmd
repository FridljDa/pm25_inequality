...
```{r}
ggsave(
  filename = here("data/18_figures/di_gee-real-25/figure_cov_ethnicity.png"),
  combined_plot
)
```
...
```{r}
ggsave(
  filename = here("data/18_figures/di_gee-real-25/figure_cov_education.png"),
  combined_plot
)
```
...
```{r}
ggsave(
  filename = here("data/18_figures/di_gee-real-25/figureS8.png"),
