...
attr_burd1 <- attr_burd %>% filter(agr_by == "nation" & svi_bin == "666" & Education == 666 & Ethnicity != "All, All Origins" & measure3 == "value" & rural_urban_class == "All")
g1 <- ggplot(attr_burd1, aes(x = Year, y = mean, color = Ethnicity))

attr_burd2 <- attr_burd %>% filter(agr_by == "nation" & svi_bin == "666" & Education != 666 & Ethnicity == "All, All Origins" & measure3 == "value" & rural_urban_class == "All")
...
attr_burd3 <- attr_burd %>% filter(agr_by == "nation"& svi_bin == "666" & Education == 666 & Ethnicity == "All, All Origins" & measure3 == "value" &
...
attr_burd5 <- attr_burd %>% filter(agr_by == "nation" & svi_bin == "666"& Education != 666 & Ethnicity == "All, All Origins" & measure3 == "prop. of overall burden" & rural_urban_class == "All")
g5 <- ggplot(attr_burd5, aes(x = Year, y = mean, color = Education))

attr_burd6 <- attr_burd %>% filter(agr_by == "nation" & svi_bin == "666"& Education == 666 & Ethnicity == "All, All Origins" & measure3 == "prop. of overall burden" &
  rural_urban_class != "All" & Year >= 2000)
...
gs <- append(plots, list(t3, t4, t5, t6, t7, t1, t2))
