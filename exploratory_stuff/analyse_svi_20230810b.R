...
library(readxl)
#devtools::load_all()
#devtools::load_all("/Users/default/Documents/Research_too_large/pm25_inequality")


# List of years for which you have CSV files
years <- c(2000, 2010, 2014, 2016, 2018, 2020)
...
for(year_dem in 1990:2016){ #1990:2016
  ...
  list_of_counties <- list(
    ...
    svi_county_2014 = svi_county[["2014"]]$FIPS %>% as.numeric(),
    svi_county_2016 = svi_county[["2016"]]$FIPS %>% as.numeric(),
  ...
  data <- data.frame(year_dem = year_dem,
                     ...
                     value_of_lowest = value_of_lowest,
                     column_with_lowest_value2 = column_with_lowest_value2,
                     value_of_lowest2 = value_of_lowest2)
