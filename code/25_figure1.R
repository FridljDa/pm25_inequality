...
if (rlang::is_empty(args)) {
  ...
  summaryDir <- "data/15_summary" # 15_summary
...
attr_burd6 <- attr_burd %>% filter(agr_by == "nation" & Education == 666 & Ethnicity == "All, All Origins" & measure3 == "prop. of overall burden" &
  rural_urban_class != "All" & Year >= 2000)
