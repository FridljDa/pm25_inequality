...
ggsave(file.path(figuresDir, paste0(methodI,"-",scenarioI), "figure2.png"), dpi = 300, g_combined, height = 9, width = 8)
ggsave(file.path(figuresDir, paste0(methodI,"-",scenarioI), "figure2.pdf"), dpi = 300, g_combined, height = 9, width = 8)