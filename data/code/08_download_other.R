...
if (rlang::is_empty(args)) {
  ...
  expDir <- "/Volumes/fridljand/R/HIGH/data/01_exposure"
  tracDir <- "/Volumes/fridljand/R/HIGH/data/02_tracts"
  ...
  #expDir <- "/g/huber/users/fridljand/R/HIGH/data/01_exposure"
  #tracDir <- "/g/huber/users/fridljand/R/HIGH/data/02_tracts"
}
#-- load data---
